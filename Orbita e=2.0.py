...
Condiciones: sin termino oscilante, e = 2.0, x = 0.0, v = 1.0, N = 1000, t = 15.
...
calculo_vdp_m = calculo_vdp[150:]   #Quitamos la region inicial del movimiento
...
title('e = 2.0, x_o = 0.0, v_o = 1.0, t = 15', fontsize=9)
show()
