...
for j in range(100,1000,200):   #Se toman puntos cada 10 segundos
    P_x.append(calculo_vdp[j,0])
    P_v.append(calculo_vdp[j,1])

#Diagrama de poincare de esta solucion.

plot(P_x, P_v, 'r.')
xlabel('Posicion')
ylabel('Velocidad')
suptitle('Espacio de Fases. Diagrama de Poincare. Oscilador Van der Pol', fontsize=12, fontweight='bold')
